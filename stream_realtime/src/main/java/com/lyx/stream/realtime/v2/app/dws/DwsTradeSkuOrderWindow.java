...
import com.lyx.stream.realtime.v1.bean.TradeSkuOrderBean;
...
/**
 * @Package com.lyx.stream.realtime.v2.app.dws.DwsTradeSkuOrderWindow
 * @Author yuxin_li
...
public class DwsTradeSkuOrderWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_trade_order_detail_yuxin_li", "dws_trade_sku_order_window");
