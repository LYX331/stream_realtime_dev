...
public class MapOrderAndDetailRateModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public MapOrderAndDetailRateModelFunc(List<com.lyx.stream.realtime.v2.app.funcc.DimBaseCategory> dimBaseCategories, double timeRate, double amountRate, double brandRate, double categoryRate) {
