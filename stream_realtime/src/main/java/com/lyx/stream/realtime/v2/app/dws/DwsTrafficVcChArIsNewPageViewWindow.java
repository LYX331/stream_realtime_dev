...
import com.lyx.stream.realtime.v1.bean.TrafficVcChArIsNewPageViewBean;
...
public class DwsTrafficVcChArIsNewPageViewWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_traffic_page_yuxin_li", "dws_traffic_vc_ch_ar_is_new_page_view_window");
