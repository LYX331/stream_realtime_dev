...
//        String sql = "select id, category_name, search_category from sx_003.category_compare_dic;";
...
//        }
//
//        jsonObject.put("ts",jsonObject.getString("ts").split(",")[0]);
//
//        return jsonObject;
//
//    }
