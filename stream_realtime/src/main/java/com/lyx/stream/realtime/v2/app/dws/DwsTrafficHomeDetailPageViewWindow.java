...
import com.lyx.stream.realtime.v1.bean.TrafficHomeDetailPageViewBean;
...
/**
 * @Package com.lyx.stream.realtime.v2.app.dws.DwsTrafficHomeDetailPageViewWindow
 * @Author yuxin_li
...
public class DwsTrafficHomeDetailPageViewWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_traffic_page_yuxin_li", "dws_traffic_home_detail_page_view_window");
